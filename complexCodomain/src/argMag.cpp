...
int main(){
	...
	*/
		...
		for(int i = 0; i < 4 - numbers.length(); i++) numbers = "0" + numbers;

		fnb = "../pics/mandos/" + numbers + "iter.bmp";
		fnt = "../text/mandos/" + numbers + "iter.txt";
	...
	*/
	...
	/*
	map = makeMap(1000, 1000, -.225, -.215, .01, -.01, function);
	createPicture(1000, 1000, map, "coolthingy2.bmp");
	*/
